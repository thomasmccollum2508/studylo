...
export default function SettingsAccount() {
  ...
  async function handleSaveProfile(e: React.FormEvent) {
    ...
    if (error) {
      ...
      await supabase.auth.updateUser({ data: { full_name: name, username: username || undefined } });
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Your name, username, and email.</p>
      </div>
        ...
        {!showChangePassword ? (
          ...
          <form onSubmit={handleChangePassword} className="mt-2 space-y-3 max-w-sm">
            ...
            <div className="flex gap-2">
              ...
              <button type="button" onClick={() => { setShowChangePassword(false); setMessage(null); }} className="px-3 py-1.5 text-gray-600 dark:text-gray-400 text-sm">
                Cancel
              </button>
            </div>
          </form>
