      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="max-w-6xl">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">Review and master your study materials</p>
              ...
              {[
                ...
                <div key={index} className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-all cursor-pointer">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-lg">{deck.title}</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-gray-900 dark:text-gray-100">{deck.cards}</span>
                    </div>
                    <div className="flex justify-between text-sm">
