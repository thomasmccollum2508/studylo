    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 px-3">
          ...
          <Link href="/flashcards" className="flex items-center gap-3 px-3 py-2.5 mb-1 bg-blue-50 text-blue-600 rounded-lg font-medium">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="max-w-6xl">
            ...
            <p className="text-gray-600 mb-6">Review and master your study materials</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { title: 'Organic Chemistry Terms', cards: 45, mastered: 32 },
                { title: 'Spanish Vocabulary', cards: 60, mastered: 25 },
                { title: 'History Dates', cards: 38, mastered: 30 },
                { title: 'Math Formulas', cards: 28, mastered: 20 },
              ].map((deck, index) => (
                <div key={index} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-900 text-lg">{deck.title}</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="pt-2">
                      <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div className="h-full bg-green-600 rounded-full" style={{ width: `${(deck.mastered / deck.cards) * 100}%` }}></div>
                      </div>
                    </div>
                  </div>
                </div>
