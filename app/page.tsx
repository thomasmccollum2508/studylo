    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="w-full px-6 pt-0 pb-12 bg-white -mt-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-[32px] shadow-md border border-gray-200 p-5 relative transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
            {/* Window controls */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              {/* Flashcard Card */}
              <div className="bg-white rounded-[32px] shadow-md border border-gray-200 p-6 animate-float transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-blue-300 cursor-pointer" style={{ animationDelay: '0s' }}>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-full bg-[#0055FF] flex items-center justify-center flex-shrink-0 shadow-[0_0_12px_rgba(0,85,255,0.5)] transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(0,85,255,0.7)]">
              ...
              {/* Quiz Card */}
              <div className="bg-white rounded-[32px] shadow-md border border-gray-200 p-6 animate-float transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-orange-300 cursor-pointer" style={{ animationDelay: '0.5s' }}>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-full bg-[#F97316] flex items-center justify-center flex-shrink-0 shadow-[0_0_12px_rgba(249,115,22,0.5)] transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(249,115,22,0.7)]">
                ...
                <div className="mb-2">
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-[#F97316] h-2 rounded-full transition-all duration-300" style={{ width: '80%' }}></div>
                  </div>
                </div>
              ...
              {/* Study Set Card */}
              <div className="bg-white rounded-[32px] shadow-md border border-gray-200 p-6 animate-float transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-teal-300 cursor-pointer" style={{ animationDelay: '1s' }}>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-full bg-[#14B8A6] flex items-center justify-center flex-shrink-0 shadow-[0_0_12px_rgba(20,184,166,0.5)] transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(20,184,166,0.7)]">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="w-full px-6 py-16 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-md transition-all duration-300 hover:-translate-y-3 hover:shadow-xl hover:scale-[1.02] hover:border-blue-300 cursor-pointer group">
              <div className="w-12 h-12 rounded-xl bg-[#0055FF] flex items-center justify-center mb-4 shadow-[0_0_12px_rgba(0,85,255,0.4)] transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(0,85,255,0.6)] group-hover:rotate-3">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13 2L10 10H15L9 22L12 14H7L13 2Z" fill="white"/>
                </svg>
              </div>
              <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">AI Flashcard Generator</h3>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-md transition-all duration-300 hover:-translate-y-3 hover:shadow-xl hover:scale-[1.02] hover:border-blue-300 cursor-pointer group">
              ...
              <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">Smart Quizzes</h3>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-md transition-all duration-300 hover:-translate-y-3 hover:shadow-xl hover:scale-[1.02] hover:border-blue-300 cursor-pointer group">
              ...
              <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">Instant Study Sets</h3>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-md transition-all duration-300 hover:-translate-y-3 hover:shadow-xl hover:scale-[1.02] hover:border-blue-300 cursor-pointer group">
              ...
              <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">Spaced Repetition</h3>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-md transition-all duration-300 hover:-translate-y-3 hover:shadow-xl hover:scale-[1.02] hover:border-blue-300 cursor-pointer group">
              ...
              <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">Study in Minutes</h3>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-md transition-all duration-300 hover:-translate-y-3 hover:shadow-xl hover:scale-[1.02] hover:border-blue-300 cursor-pointer group">
              ...
              <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">Share & Collaborate</h3>
      ...
      <section className="w-full px-6 py-16 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Comparison Table */}
          <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            <div className="overflow-x-auto">
              <table className="w-full table-fixed">
                <thead>
                  <tr>
                    ...
                    <th className="text-center pt-2 pb-3 px-6 align-middle border-b border-gray-200 w-1/3">
                      <span className="bg-[#0055FF] text-white px-6 py-1.5 rounded-full text-sm font-semibold inline-block transition-all duration-300 hover:scale-110 hover:shadow-lg">
                        Studylo
                      </span>
                    </th>
                  </tr>
                ...
                <tbody>
                  {/* Row 1 */}
                  <tr className="transition-all duration-200 hover:bg-blue-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              ...
              <div className="text-center transition-all duration-300 hover:-translate-y-2 cursor-pointer group">
                <div className="relative mb-6">
                  <span className="text-8xl font-bold text-gray-200/40 absolute -top-8 left-1/2 transform -translate-x-1/2 -z-10 transition-all duration-300 group-hover:text-gray-300/50">01</span>
                  <div className="w-16 h-16 rounded-full bg-[#0055FF] flex items-center justify-center mx-auto shadow-[0_0_12px_rgba(0,85,255,0.4)] relative z-10 transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(0,85,255,0.6)] group-hover:rotate-6">
                ...
                <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">Upload Your Material</h3>
              ...
              <div className="text-center transition-all duration-300 hover:-translate-y-2 cursor-pointer group">
                <div className="relative mb-6">
                  <span className="text-8xl font-bold text-gray-200/40 absolute -top-8 left-1/2 transform -translate-x-1/2 -z-10 transition-all duration-300 group-hover:text-gray-300/50">02</span>
                  <div className="w-16 h-16 rounded-full bg-[#0055FF] flex items-center justify-center mx-auto shadow-[0_0_12px_rgba(0,85,255,0.4)] relative z-10 transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(0,85,255,0.6)] group-hover:rotate-6">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">AI Does the Work</h3>
              ...
              <div className="text-center transition-all duration-300 hover:-translate-y-2 cursor-pointer group">
                <div className="relative mb-6">
                  <span className="text-8xl font-bold text-gray-200/40 absolute -top-8 left-1/2 transform -translate-x-1/2 -z-10 transition-all duration-300 group-hover:text-gray-300/50">03</span>
                  <div className="w-16 h-16 rounded-full bg-[#0055FF] flex items-center justify-center mx-auto shadow-[0_0_12px_rgba(0,85,255,0.4)] relative z-10 transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(0,85,255,0.6)] group-hover:rotate-6">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">Study Smarter</h3>
              ...
              <div className="text-center transition-all duration-300 hover:-translate-y-2 cursor-pointer group">
                <div className="relative mb-6">
                  <span className="text-8xl font-bold text-gray-200/40 absolute -top-8 left-1/2 transform -translate-x-1/2 -z-10 transition-all duration-300 group-hover:text-gray-300/50">04</span>
                  <div className="w-16 h-16 rounded-full bg-[#0055FF] flex items-center justify-center mx-auto shadow-[0_0_12px_rgba(0,85,255,0.4)] relative z-10 transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(0,85,255,0.6)] group-hover:rotate-6">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="text-gray-900 font-bold text-lg mb-2 transition-colors duration-300 group-hover:text-[#0055FF]">Ace Your Exams</h3>
