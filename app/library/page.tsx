      ...
      <section className="w-full px-6 pb-16 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Study Sets */}
            <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-gradient-to-b from-blue-50 to-white rounded-3xl border border-gray-200 shadow-md p-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <button className="bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 px-8 py-4 rounded-[15px] text-lg font-medium transition-all duration-300 hover:-translate-y-1 hover:scale-105">
                Browse Community
              </button>
            </div>
          </div>
